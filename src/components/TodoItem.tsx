...
export const TodoItem: React.FC<TodoItemProps> = ({ todo, deleteToDo, changeDone, moveUp, moveDown, select, changeSelected }) => {
	...
	return (
		<div key={todo.id} className="inline-flex justify-end items-center max-w-lg gap-3 w-full min-w-xs text-md p-3.5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" onMouseEnter={toggleIsShown} onMouseLeave={toggleIsShown}>
